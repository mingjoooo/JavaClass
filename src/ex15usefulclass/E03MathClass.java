...
public class E03MathClass extends Object {
	...
	public static void main(String[] args) {
		...
		System.out.println("Math.round"+Math.round(-1.4)); //버림처리됨
		System.out.println("Math.round"+Math.round(-1.5)); //버림처리됨
		System.out.println("Math.round"+Math.round(-3.51)); //올림처리됨
