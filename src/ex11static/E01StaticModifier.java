...
class MyStatic{
	...
	/*
	멤버변수] (일반적인 변수)인스턴스형 멤버변수는 반드시 클래스의 객체를 생성한 후
		참조변수를 통해 접근해야한다.
	 */
	int instanceVar;
	/*
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		정적 멤버메소드의 접근방법은 정적방법의 접근방법과 동일하다.
		 */
		myStatic.intstanceMethod();
		myStatic.staticMethod(); //권장사항이 아니므로 클래스명을 사용한는게 좋다.
		
		//클래스를 통해서 호출
		//Mystatic.intstanceMethod(); //=>에러발생. 참조변수를 통해서만 호출할 수 있다.
