...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		시나리오] E03 예제의 1~10까지의 더하는 수열문제를 do~while문으로
			변경하여 구현하시오.
		 */
		int sum = 0; //합의 초기화
		int i = 1; //반복을 위한 변수
		...
		do { //조건검사 없이 진입
			if(j%4==0 || j%7==0) { //4 또는 7의 배수일때...
				...
				total += j; //증가하는 j의 값을 누적해서 더한 후 total에 대입
			}
			j++;
...
//		}
		...
		//문자(하나)를 입력받기 위한 변수(System.in.read();)
		int exitCode;
		do {
