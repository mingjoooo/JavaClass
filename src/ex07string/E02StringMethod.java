...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println("J를 G로 변경하기"); //변화없음
		...
		System.out.println("str1 첫번째 문자의 아스키코드:"+str1.codePointAt(0)); //W의 아스키코드
		System.out.println("str2 첫번째 문자의 아스키코드:"+str2.codePointAt(0)); //자의 아스키코드
	}
}
