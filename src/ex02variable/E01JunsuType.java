...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		/*
		 ...
		 -각 자료형의 표현범위는 교안을 참고한다(외울필요없음)
		 -일반적으로 CPU(중앙처리장치)는 정수형 연산을 할때 int 형을
		 가장 빠르게 처리한다.
		 -즉 , 정수형 변수를 쓸때에는 거의 대부분 int형을 사용한다.
		 */
		int int1 = 100;
		int int2 = 200;
		...
		int result2 = byte1 + byte2; // byte + byte = int형의 결과출력
		...
		/*
		-동일자료형끼리의 연산은 통일자료형이 되는것이 기본원칙이다.
		...
		이때는 접미사(l or L)붙여서 int형 자료가 아닌 long형 자료임을
